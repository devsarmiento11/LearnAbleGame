...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (hasPointer && isHoveringObject)
            {
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (TMP_ExamplePointer.ShiftPressed))
                {
                ...
                if (wordIndex != -1 && wordIndex != m_selectedWord && !(TMP_ExamplePointer.ShiftPressed))
                {
